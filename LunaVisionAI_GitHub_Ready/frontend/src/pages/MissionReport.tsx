...
export default function MissionReport() {
  ...
  const isCritical = analysisResult.readiness_status === 'NO GO';
  ...
  const pieData = [
    { name: 'Healthy Tissue', value: analysisResult.safety_score },
    { name: 'Anomalies', value: 100 - analysisResult.safety_score },
  ];
  const pieColors = ['var(--color-success)', 'var(--color-danger)'];
