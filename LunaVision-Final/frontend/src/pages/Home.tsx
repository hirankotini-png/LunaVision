    ...
    <div className="space-y-8">
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="flex justify-between items-center">
        <div>
          ...
          <p className="text-gray-400">Current active session overview.</p>
        </div>
      </motion.div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        <motion.div initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} transition={{ delay: 0.4 }} className="glass-card p-8 flex flex-col items-center text-center">
          <UploadCloud size={64} className="text-primary mb-6" />
          <h2 className="text-2xl font-bold mb-2">New Surface Analysis</h2>
          <p className="text-gray-400 mb-8 max-w-sm">Upload lunar surface imagery to generate hazard maps, safe landing zones, and rover pathing.</p>
          <Link to="/upload" className="px-8 py-3 bg-primary hover:bg-blue-600 text-white rounded-xl font-medium transition-all shadow-[0_0_20px_rgba(30,136,229,0.4)]">
            Start Upload
          </Link>
        </motion.div>
